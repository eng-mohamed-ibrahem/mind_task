...
abstract class $CategoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, @JsonKey(name: 'cat_name') String catName, String icon});
}
...
class _$CategoryModelImpl implements _CategoryModel {
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, catName: $catName, icon: $icon)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, catName, icon);
