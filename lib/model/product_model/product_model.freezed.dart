...
class _$ProductModelImpl implements _ProductModel {
  const _$ProductModelImpl(
      ...
      @JsonKey(name: 'list_price') required this.listPrice,
  ...
  @override
  String toString() {
    return 'ProductModel(id: $id, name: $name, shortDesc: $shortDesc, mainImage: $mainImage, listPrice: $listPrice, salePrice: $salePrice, discount: $discount, rating: $rating)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, shortDesc, mainImage,
      listPrice, salePrice, discount, rating);
...
abstract class _ProductModel implements ProductModel {
  const factory _ProductModel(
      ...
      @JsonKey(name: 'list_price') required final String listPrice,
      @JsonKey(name: 'sale_price') required final String salePrice,
      required final String discount,
      final String? rating}) = _$ProductModelImpl;
